...
public class StickyLayout extends LinearLayout {
    ...
    public StickyLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.StickyLayout);
        topOffset = a.getDimensionPixelSize(a.getIndex(R.styleable.StickyLayout_hvp_topOffset), topOffset);
        a.recycle();
...
//                mDisallowIntercept = false;
            ...
            case MotionEvent.ACTION_MOVE:
                 ...
                 */
                if (verticalScrollFlag && (!isStickied() || mScrollable.getScrollableView() == null || mScrollable.isTop() || isClickHead)) {
    ...
    public void computeScroll() {
        if (mScroller.computeScrollOffset()) {
            ...
            if (mDirection == DIRECTION_UP) {
                ...
                if (mScrollable.getScrollableView() == null || mScrollable.isTop() || isClickHead) {
